export default class gameScene1 extends Phaser.Scene {
    ...
    preload() {    
        this.load.image('tiles', './assets/tileset/spritesheet-tiles-default.png');
    ...
    create() {
        ...
        const flag = map.createLayer('flag', tileset, 0, 0);
        const decor = map.createLayer('arrow', tileset, 0, 0);
        this.death = map.createLayer('death', tileset, 0, 0);
        this.water = map.createLayer('water', tileset, 0, 0);

        // Create the player sprite and enable physics
        this.player = this.physics.add.sprite(0, 800, 'player');
        ...
        //Coin
        this.creatingCoin(240, 810);
        this.creatingCoin(480, 683);
        this.creatingCoin(1670, 748);
        this.creatingCoin(1305, 620);
        this.creatingCoin(935, 620);
        ...
        this.hearts = 3
        this.heartstext = this.add.bitmapText(525, 289, 'font', 'Hearts: 03', 13).setScrollFactor(0).setOrigin(0, 0);

        this.score = 0;
        this.scoreText = this.add.bitmapText(925, 289, 'font', 'Score: 00', 13).setScrollFactor(0).setOrigin(0, 0);
        
        this.coin = 0;
        this.coinsText = this.add.bitmapText(1325, 289, 'font', 'Coins: 00', 13).setScrollFactor(0).setOrigin(0, 0);
    }
    ...
    Win(){
        this.gameBG.stop();
        this.scene.start('gameScene2', { score: this.score, coin: this.coin, hearts: this.hearts });
    }
}