export default class gameScene3 extends Phaser.Scene {
    ...
    preload() {    
        this.load.image('level3Tiles', './assets/tileset/spritesheet-tiles-default.png');
        this.load.tilemapTiledJSON('level3Map', './assets/tilemaps/level3.json');  
    }
    ...
    create() {
        ...
        const level3Tiles = map.addTilesetImage("levelthreetileset", 'level3Tiles');
        const ground = map.createLayer('ground', level3Tiles, 0, 0);
        const flag = map.createLayer('flag', level3Tiles, 0, 0);
        const decor = map.createLayer('arrow', level3Tiles, 0, 0);
        this.death = map.createLayer('death', level3Tiles, 0, 0);
        this.water = map.createLayer('water', level3Tiles, 0, 0);
        ...
        //Coin
        this.creatingCoin(240, 420);
        this.creatingCoin(550, 300);
        this.creatingCoin(1670, 428);
        this.creatingCoin(1305, 235);
        this.creatingCoin(935, 235);
    ...
    Win(){
        this.gameBG.stop();
        this.scene.start('winScene', { score: this.score, coin: this.coin, hearts: this.hearts });
    }
}